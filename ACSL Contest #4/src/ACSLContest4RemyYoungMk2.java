...
//Remy Young
//4/ 17/15
//Code referenced from https://github.com/rockfight/Quine-McCluskey-algorithm/blob/master/src/quineMccluskey/QuineMcCluskeyAlgorithm.java

import java.util.*;
import java.io.*;
import java.lang.*;

public class ACSLContest4RemyYoungMk2 {
    ...
    public static int[] scan_minterms() {
        ...
        for(int i = 0; i<data.length-1; i++) {
            temp_array[b] = Integer.parseInt(data[b]);
            b++;
        }
    ...
    public static String[][] fill_minterms(String[] input_min) {
        ...
        while (input_min[a] != "-1") {
            ...
            if (count == 0) {
                ...
                group_wise[13][thirteens] = temp_min;
                thirteens++;
           }
